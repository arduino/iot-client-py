...
class ArduinoCompressedv2(object):
    ...
    def __init__(self, authority_key_identifier=None, not_after=None, not_before=None, serial=None, signature=None, signature_asn1_x=None, signature_asn1_y=None):  # noqa: E501

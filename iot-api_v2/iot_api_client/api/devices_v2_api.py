...
class DevicesV2Api(object):
    ...
    def devices_v2_get_properties_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iot/v2/devices/{id}/properties', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def devices_v2_image(self, id, configv2, **kwargs):  # noqa: E501
        """image devices_v2  # noqa: E501

        Returns an iso image to be burned into a usb key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.devices_v2_image(id, configv2, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The id of the resource (required)
        :param list[Configv2] configv2: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.devices_v2_image_with_http_info(id, configv2, **kwargs)  # noqa: E501

    def devices_v2_image_with_http_info(self, id, configv2, **kwargs):  # noqa: E501
        """image devices_v2  # noqa: E501

        Returns an iso image to be burned into a usb key  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.devices_v2_image_with_http_info(id, configv2, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'configv2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method devices_v2_image" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `devices_v2_image`")  # noqa: E501
        # verify the required parameter 'configv2' is set
        if ('configv2' not in local_var_params or
                local_var_params['configv2'] is None):
            raise ApiValueError("Missing the required parameter `configv2` when calling `devices_v2_image`")  # noqa: E501
        ...
        body_params = None
        if 'configv2' in local_var_params:
            body_params = local_var_params['configv2']
        # HTTP header `Content-Type`
        header_params['Content-Type'] = self.api_client.select_header_content_type(  # noqa: E501
            ['application/json'])  # noqa: E501
    ...
    def devices_v2_timeseries_with_http_info(self, id, pid, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iot/v2/devices/{id}/properties/{pid}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,

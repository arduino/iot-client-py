...
class DevicesV2CertsApi(object):
    ...
    def devices_v2_certs_create_with_http_info(self, id, create_devices_v2_certs_payload, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'create_devices_v2_certs_payload']  # noqa: E501
        ...
        if ('create_devices_v2_certs_payload' not in local_var_params or
                local_var_params['create_devices_v2_certs_payload'] is None):
        ...
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/vnd.arduino.devicev2.cert+json'])  # noqa: E501
    ...
    def devices_v2_certs_list_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/vnd.arduino.devicev2.cert+json; type=collection'])  # noqa: E501
    ...
    def devices_v2_certs_update_with_http_info(self, cid, id, devicev2_cert, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'id', 'devicev2_cert']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('devicev2_cert' not in local_var_params or
                local_var_params['devicev2_cert'] is None):

...
class ThingsV1Api(object):
    ...
    def things_v1_delete_sketch_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iot/v1/things/{id}/sketch', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def things_v1_shadow(self, id, thing_properties_values, **kwargs):  # noqa: E501
        """shadow things_v1  # noqa: E501

        Publish the last property values to MQTT  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.things_v1_shadow(id, thing_properties_values, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str id: The id of the thing (required)
        :param ThingPropertiesValues thing_properties_values: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.things_v1_shadow_with_http_info(id, thing_properties_values, **kwargs)  # noqa: E501

    def things_v1_shadow_with_http_info(self, id, thing_properties_values, **kwargs):  # noqa: E501
        """shadow things_v1  # noqa: E501

        Publish the last property values to MQTT  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.things_v1_shadow_with_http_info(id, thing_properties_values, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id', 'thing_properties_values']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method things_v1_shadow" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `things_v1_shadow`")  # noqa: E501
        # verify the required parameter 'thing_properties_values' is set
        if ('thing_properties_values' not in local_var_params or
                local_var_params['thing_properties_values'] is None):
            raise ApiValueError("Missing the required parameter `thing_properties_values` when calling `things_v1_shadow`")  # noqa: E501
        ...
        body_params = None
        if 'thing_properties_values' in local_var_params:
            body_params = local_var_params['thing_properties_values']
        # HTTP header `Content-Type`
        header_params['Content-Type'] = self.api_client.select_header_content_type(  # noqa: E501
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iot/v1/things/{id}/shadow/send', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def things_v1_update_sketch_with_http_info(self, id, sketch_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/iot/v1/things/{id}/sketch/{sketchId}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,

...
class LoraDevicesV1Api(object):
    ...
    def lora_devices_v1_create(self, create_lora_devices_v1_payload, **kwargs):  # noqa: E501
        ...
        Create a new lora device. Its info are saved on our database, and on the a2a network. Creates a device_v2 automatically  # noqa: E501
    ...
    def lora_devices_v1_create_with_http_info(self, create_lora_devices_v1_payload, **kwargs):  # noqa: E501
        ...
        all_params = ['create_lora_devices_v1_payload']  # noqa: E501
        ...
        if ('create_lora_devices_v1_payload' not in local_var_params or
                local_var_params['create_lora_devices_v1_payload'] is None):

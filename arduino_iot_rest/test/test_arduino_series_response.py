...
from arduino_iot_rest.models.arduino_series_response import ArduinoSeriesResponse  # noqa: E501
...
class TestArduinoSeriesResponse(unittest.TestCase):
    ...
    def testArduinoSeriesResponse(self):
        ...
        # model = arduino_iot_rest.models.arduino_series_response.ArduinoSeriesResponse()  # noqa: E501
        pass

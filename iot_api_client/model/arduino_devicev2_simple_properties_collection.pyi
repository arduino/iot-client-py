...
class ArduinoDevicev2SimplePropertiesCollection(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ArduinoDevicev2SimpleProperties']:
            return ArduinoDevicev2SimpleProperties

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArduinoDevicev2SimpleProperties'], typing.List['ArduinoDevicev2SimpleProperties']],
    ...
    def __getitem__(self, i: int) -> 'ArduinoDevicev2SimpleProperties':

...
class ArduinoPropertyCollection(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ArduinoProperty']:
            return ArduinoProperty

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArduinoProperty'], typing.List['ArduinoProperty']],
    ...
    def __getitem__(self, i: int) -> 'ArduinoProperty':

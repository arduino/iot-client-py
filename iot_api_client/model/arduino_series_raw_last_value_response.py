...
class ArduinoSeriesRawLastValueResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count_values", "property_id", "thing_id", "times", "values", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count_values", "property_id", "thing_id", "times", "values", ], str]):

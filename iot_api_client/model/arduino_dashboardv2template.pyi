...
class ArduinoDashboardv2template(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "cover_image", "id", "widgets", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "cover_image", "id", "widgets", ], str]):

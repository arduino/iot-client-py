...
class ArduinoDashboardshareCollection(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ArduinoDashboardshare']:
            return ArduinoDashboardshare

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArduinoDashboardshare'], typing.List['ArduinoDashboardshare']],
    ...
    def __getitem__(self, i: int) -> 'ArduinoDashboardshare':

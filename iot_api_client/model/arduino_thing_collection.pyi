...
class ArduinoThingCollection(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ArduinoThing']:
            return ArduinoThing

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArduinoThing'], typing.List['ArduinoThing']],
    ...
    def __getitem__(self, i: int) -> 'ArduinoThing':

...
class BatchQuerySampledRequestMediaV1(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["q", "from", "interval", "series_limit", "to", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["q", "from", "interval", "series_limit", "to", ], str]):

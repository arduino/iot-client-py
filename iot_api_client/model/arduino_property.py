...
class ArduinoProperty(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["href", "id", "name", "permission", "thing_id", "type", "update_strategy", "created_at", "deleted_at", "last_value", "max_value", "min_value", "persist", "sync_id", "tag", "thing_name", "update_parameter", "updated_at", "value_updated_at", "variable_name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["href", "id", "name", "permission", "thing_id", "type", "update_strategy", "created_at", "deleted_at", "last_value", "max_value", "min_value", "persist", "sync_id", "tag", "thing_name", "update_parameter", "updated_at", "value_updated_at", "variable_name", ], str]):

...
class ArduinoThingresultCollection(
    schemas.ListSchema
):
    ...
    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArduinoThingresult'], typing.List['ArduinoThingresult']],
    ...
    def __getitem__(self, i: int) -> 'ArduinoThingresult':

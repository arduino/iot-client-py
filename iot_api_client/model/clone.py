...
class Clone(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class overrides(
                ...
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['Override'], typing.List['Override']],
                ...
                def __getitem__(self, i: int) -> 'Override':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["overrides", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["overrides", ], str]):

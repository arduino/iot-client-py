...
class BatchQueryRequestsMediaV1(
        ...
        class properties:
            ...
            class requests(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BatchQueryRequestMediaV1']:
                        return BatchQueryRequestMediaV1
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['BatchQueryRequestMediaV1'], typing.List['BatchQueryRequestMediaV1']],
                ...
                def __getitem__(self, i: int) -> 'BatchQueryRequestMediaV1':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["requests", "resp_version", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["requests", "resp_version", ], str]):

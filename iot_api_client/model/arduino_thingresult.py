...
class ArduinoThingresult(
    ...
    sketch_id: MetaOapg.properties.sketch_id
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "sketch_id", "device_id", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["sketch_id"]) -> MetaOapg.properties.sketch_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "sketch_id", "device_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        sketch_id: typing.Union[MetaOapg.properties.sketch_id, str, uuid.UUID, ],

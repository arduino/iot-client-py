...
class ArduinoDashboardv2Collection(
    schemas.ListSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['ArduinoDashboardv2']:
            return ArduinoDashboardv2

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['ArduinoDashboardv2'], typing.List['ArduinoDashboardv2']],
    ...
    def __getitem__(self, i: int) -> 'ArduinoDashboardv2':

...
class ThingClone(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "include_tags", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "include_tags", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        include_tags: typing.Union[MetaOapg.properties.include_tags, bool, schemas.Unset] = schemas.unset,

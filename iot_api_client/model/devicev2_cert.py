...
class Devicev2Cert(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ca", "csr", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ca", "csr", "enabled", ], str]):

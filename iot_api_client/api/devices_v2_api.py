...
class DevicesV2Api:
    ...
    def _devices_v2_delete_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/iot/v2/devices/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _devices_v2_get_events_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/iot/v2/devices/{id}/events',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _devices_v2_get_properties_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/iot/v2/devices/{id}/properties',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _devices_v2_get_status_events_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/iot/v2/devices/{id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def devices_v2_list(
        ...
        :type serial: str
        :param show_deleted: If true, shows the soft deleted devices
        :type show_deleted: bool
    ...
    def _devices_v2_timeseries_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/iot/v2/devices/{id}/properties/{pid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

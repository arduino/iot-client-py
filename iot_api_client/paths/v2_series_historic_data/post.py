...
# body param
SchemaForRequestBodyApplicationJson = HistoricDataRequest
SchemaForRequestBodyApplicationXWwwFormUrlencoded = HistoricDataRequest


request_body_historic_data_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_v2_historic_data_oapg(
        self,
    ...
    def _series_v2_historic_data_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_historic_data_request.serialize(body, content_type)
...
class SeriesV2HistoricData(BaseApi):
    ...
    def series_v2_historic_data(
        ...
        return self._series_v2_historic_data_oapg(
            body=body,

...
# body param
SchemaForRequestBodyApplicationJson = BatchLastValueRequestsMediaV1
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BatchLastValueRequestsMediaV1


request_body_batch_last_value_requests_media_v1 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson = ArduinoSeriesRawBatchLastvalue
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoSeriesRawBatchLastvalue
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.raw.batch.lastvalue+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor401ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson = Error
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.raw.batch.lastvalue+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor403ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson = Error
...
_response_for_403 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.raw.batch.lastvalue+json': api_client.MediaType(
            schema=SchemaFor403ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
SchemaFor503ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson = Error
...
_response_for_503 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.raw.batch.lastvalue+json': api_client.MediaType(
            schema=SchemaFor503ResponseBodyApplicationVndArduinoSeriesRawBatchLastvaluejson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_v2_batch_query_raw_last_value_oapg(
        self,
    ...
    def _series_v2_batch_query_raw_last_value_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_batch_last_value_requests_media_v1.serialize(body, content_type)
...
class SeriesV2BatchQueryRawLastValue(BaseApi):
    ...
    def series_v2_batch_query_raw_last_value(
        ...
        return self._series_v2_batch_query_raw_last_value_oapg(
            body=body,

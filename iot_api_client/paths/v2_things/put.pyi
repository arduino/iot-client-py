...
# body param
SchemaForRequestBodyApplicationJson = ThingCreate
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ThingCreate


request_body_thing_create = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationVndArduinoThingjson = ArduinoThing
SchemaFor201ResponseBodyApplicationVndGoaErrorjson = ArduinoThing
...
_response_for_201 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.thing+json': api_client.MediaType(
            schema=SchemaFor201ResponseBodyApplicationVndArduinoThingjson),
...
class BaseApi(api_client.Api):
    ...
    def _things_v2_create_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_thing_create.serialize(body, content_type)
...
class ThingsV2Create(BaseApi):
    ...
    def things_v2_create(
        ...
        return self._things_v2_create_oapg(
            body=body,

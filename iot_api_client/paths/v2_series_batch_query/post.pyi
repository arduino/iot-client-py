...
# body param
SchemaForRequestBodyApplicationJson = BatchQueryRequestsMediaV1
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BatchQueryRequestsMediaV1


request_body_batch_query_requests_media_v1 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndArduinoSeriesBatchjson = ArduinoSeriesBatch
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoSeriesBatch
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoSeriesBatchjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor400ResponseBodyApplicationVndArduinoSeriesBatchjson = Error
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndArduinoSeriesBatchjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor401ResponseBodyApplicationVndArduinoSeriesBatchjson = Error
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoSeriesBatchjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor403ResponseBodyApplicationVndArduinoSeriesBatchjson = Error
...
_response_for_403 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch+json': api_client.MediaType(
            schema=SchemaFor403ResponseBodyApplicationVndArduinoSeriesBatchjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
SchemaFor503ResponseBodyApplicationVndArduinoSeriesBatchjson = Error
...
_response_for_503 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch+json': api_client.MediaType(
            schema=SchemaFor503ResponseBodyApplicationVndArduinoSeriesBatchjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_v2_batch_query_oapg(
        self,
    ...
    def _series_v2_batch_query_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_batch_query_requests_media_v1.serialize(body, content_type)
...
class SeriesV2BatchQuery(BaseApi):
    ...
    def series_v2_batch_query(
        ...
        return self._series_v2_batch_query_oapg(
            body=body,

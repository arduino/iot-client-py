...
SchemaFor200ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson = ArduinoDevicev2StatusEvents
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoDevicev2StatusEvents
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.status.events+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson),
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.status.events+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.status.events+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
_response_for_500 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.status.events+json': api_client.MediaType(
            schema=SchemaFor500ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor500ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor503ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson = Error
...
_response_for_503 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.status.events+json': api_client.MediaType(
            schema=SchemaFor503ResponseBodyApplicationVndArduinoDevicev2StatusEventsjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    @typing.overload
    def _devices_v2_get_status_events_oapg(
        self,
...
class DevicesV2GetStatusEvents(BaseApi):
    ...
    def devices_v2_get_status_events(
        ...
        return self._devices_v2_get_status_events_oapg(

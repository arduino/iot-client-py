...
SchemaFor200ResponseBodyApplicationVndArduinoDashboardv2json = ArduinoDashboardv2
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoDashboardv2
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.dashboardv2+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoDashboardv2json),
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dashboards_v2_update_oapg(
        self,
...
class DashboardsV2Update(BaseApi):
    ...
    def dashboards_v2_update(
        ...
        return self._dashboards_v2_update_oapg(
            body=body,

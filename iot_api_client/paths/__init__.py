...
class PathValues(str, enum.Enum):
    ...
    V1_PROPERTY_TYPES = "/v1/property_types"
    ...
    V2_DASHBOARDS_ID_TEMPLATE = "/v2/dashboards/{id}/template"
    ...
    V2_DEVICES_ID_STATUS = "/v2/devices/{id}/status"
    ...
    V2_THINGS_ID_CLONE = "/v2/things/{id}/clone"
    ...
    V2_THINGS_ID_TEMPLATE = "/v2/things/{id}/template"

...
SerialSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'serial': typing.Union[SerialSchema, str, ],
...
request_query_serial = api_client.QueryParameter(
    name="serial",
    style=api_client.ParameterStyle.FORM,
    schema=SerialSchema,
    explode=True,
...
SchemaFor200ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection = ArduinoDevicev2Collection
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoDevicev2Collection
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2+json; type=collection': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor400ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection = Error
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2+json; type=collection': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor401ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection = Error
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2+json; type=collection': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection),
        'application/vnd.goa.error+json': api_client.MediaType(
...
_response_for_500 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2+json; type=collection': api_client.MediaType(
            schema=SchemaFor500ResponseBodyApplicationVndArduinoDevicev2jsonTypecollection),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class DevicesV2List(BaseApi):
    ...
    def devices_v2_list(
        ...
        return self._devices_v2_list_oapg(

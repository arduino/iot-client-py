...
# body param
SchemaForRequestBodyApplicationJson = Dashboardshare
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Dashboardshare


request_body_dashboardshare = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _dashboards_v2_share_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_dashboardshare.serialize(body, content_type)
...
class DashboardsV2Share(BaseApi):
    ...
    def dashboards_v2_share(
        ...
        return self._dashboards_v2_share_oapg(
            body=body,

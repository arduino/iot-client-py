...
SchemaFor200ResponseBodyApplicationVndArduinoLorafreqplansv1json = ArduinoLorafreqplansv1
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoLorafreqplansv1
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.lorafreqplansv1+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoLorafreqplansv1json),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor401ResponseBodyApplicationVndArduinoLorafreqplansv1json = Error
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.lorafreqplansv1+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoLorafreqplansv1json),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor500ResponseBodyApplicationVndArduinoLorafreqplansv1json = Error
...
_response_for_500 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.lorafreqplansv1+json': api_client.MediaType(
            schema=SchemaFor500ResponseBodyApplicationVndArduinoLorafreqplansv1json),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    @typing.overload
    def _lora_freq_plan_v1_list_oapg(
        self,
...
class LoraFreqPlanV1List(BaseApi):
    ...
    def lora_freq_plan_v1_list(
        ...
        return self._lora_freq_plan_v1_list_oapg(

...
# body param
SchemaForRequestBodyApplicationJson = PropertiesValues
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PropertiesValues


request_body_properties_values = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _devices_v2_update_properties_oapg(
        self,
    ...
    def _devices_v2_update_properties_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_properties_values.serialize(body, content_type)
...
class DevicesV2UpdateProperties(BaseApi):
    ...
    def devices_v2_update_properties(
        ...
        return self._devices_v2_update_properties_oapg(
            body=body,

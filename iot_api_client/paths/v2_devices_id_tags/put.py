...
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Tag
...
class BaseApi(api_client.Api):
    @typing.overload
    def _devices_v2_tags_upsert_oapg(
        self,
...
class DevicesV2TagsUpsert(BaseApi):
    ...
    def devices_v2_tags_upsert(
        ...
        return self._devices_v2_tags_upsert_oapg(
            body=body,

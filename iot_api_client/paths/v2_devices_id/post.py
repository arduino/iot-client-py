...
# body param
SchemaForRequestBodyApplicationJson = Devicev2
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Devicev2


request_body_devicev2 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndArduinoDevicev2json = ArduinoDevicev2
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoDevicev2
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoDevicev2json),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor400ResponseBodyApplicationVndArduinoDevicev2json = Error
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndArduinoDevicev2json),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    ...
    def _devices_v2_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_devicev2.serialize(body, content_type)
...
class DevicesV2Update(BaseApi):
    ...
    def devices_v2_update(
        ...
        return self._devices_v2_update_oapg(
            body=body,

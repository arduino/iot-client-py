...
# body param
SchemaForRequestBodyApplicationJson = PropertyValue
SchemaForRequestBodyApplicationXWwwFormUrlencoded = PropertyValue


request_body_property_value = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _properties_v2_publish_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_property_value.serialize(body, content_type)
...
class PropertiesV2Publish(BaseApi):

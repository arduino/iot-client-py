...
# body param
SchemaForRequestBodyApplicationJson = Sharerequest
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Sharerequest


request_body_sharerequest = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _dashboards_v2_request_access_oapg(
        self,
    ...
    def _dashboards_v2_request_access_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_sharerequest.serialize(body, content_type)
...
class DashboardsV2RequestAccess(BaseApi):
    ...
    def dashboards_v2_request_access(
        ...
        return self._dashboards_v2_request_access_oapg(
            body=body,

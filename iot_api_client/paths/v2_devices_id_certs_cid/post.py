...
# body param
SchemaForRequestBodyApplicationJson = Devicev2Cert
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Devicev2Cert


request_body_devicev2_cert = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndArduinoDevicev2Certjson = ArduinoDevicev2Cert
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoDevicev2Cert
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.cert+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoDevicev2Certjson),
...
class BaseApi(api_client.Api):
    @typing.overload
    def _devices_v2_certs_update_oapg(
        self,
    ...
    def _devices_v2_certs_update_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_devicev2_cert.serialize(body, content_type)
...
class DevicesV2CertsUpdate(BaseApi):
    ...
    def devices_v2_certs_update(
        ...
        return self._devices_v2_certs_update_oapg(
            body=body,

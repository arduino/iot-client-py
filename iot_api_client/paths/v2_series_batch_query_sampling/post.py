...
# body param
SchemaForRequestBodyApplicationJson = BatchQuerySampledRequestsMediaV1
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BatchQuerySampledRequestsMediaV1


request_body_batch_query_sampled_requests_media_v1 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndArduinoSeriesBatchSampledjson = ArduinoSeriesBatchSampled
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoSeriesBatchSampled
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch.sampled+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoSeriesBatchSampledjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor400ResponseBodyApplicationVndArduinoSeriesBatchSampledjson = Error
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch.sampled+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndArduinoSeriesBatchSampledjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor401ResponseBodyApplicationVndArduinoSeriesBatchSampledjson = Error
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch.sampled+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoSeriesBatchSampledjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor403ResponseBodyApplicationVndArduinoSeriesBatchSampledjson = Error
...
_response_for_403 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch.sampled+json': api_client.MediaType(
            schema=SchemaFor403ResponseBodyApplicationVndArduinoSeriesBatchSampledjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
SchemaFor503ResponseBodyApplicationVndArduinoSeriesBatchSampledjson = Error
...
_response_for_503 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.series.batch.sampled+json': api_client.MediaType(
            schema=SchemaFor503ResponseBodyApplicationVndArduinoSeriesBatchSampledjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    @typing.overload
    def _series_v2_batch_query_sampling_oapg(
        self,
    ...
    def _series_v2_batch_query_sampling_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_batch_query_sampled_requests_media_v1.serialize(body, content_type)
...
class SeriesV2BatchQuerySampling(BaseApi):
    ...
    def series_v2_batch_query_sampling(
        ...
        return self._series_v2_batch_query_sampling_oapg(
            body=body,

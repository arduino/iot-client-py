...
# body param
SchemaForRequestBodyApplicationJson = CheckDevicesV2PassPayload
SchemaForRequestBodyApplicationXWwwFormUrlencoded = CheckDevicesV2PassPayload


request_body_check_devices_v2_pass_payload = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _devices_v2_pass_check_oapg(
        self,
    ...
    def _devices_v2_pass_check_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_check_devices_v2_pass_payload.serialize(body, content_type)
...
class DevicesV2PassCheck(BaseApi):
    ...
    def devices_v2_pass_check(
        ...
        return self._devices_v2_pass_check_oapg(
            body=body,

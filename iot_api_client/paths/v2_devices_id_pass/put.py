...
# body param
SchemaForRequestBodyApplicationJson = Devicev2Pass
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Devicev2Pass


request_body_devicev2_pass = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationVndArduinoDevicev2Passjson = ArduinoDevicev2Pass
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoDevicev2Pass
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.pass+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoDevicev2Passjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor400ResponseBodyApplicationVndArduinoDevicev2Passjson = Error
...
_response_for_400 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.pass+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndArduinoDevicev2Passjson),
        'application/vnd.goa.error+json': api_client.MediaType(
            schema=SchemaFor400ResponseBodyApplicationVndGoaErrorjson),
    },
)
SchemaFor401ResponseBodyApplicationVndArduinoDevicev2Passjson = Error
...
_response_for_401 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.pass+json': api_client.MediaType(
            schema=SchemaFor401ResponseBodyApplicationVndArduinoDevicev2Passjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
SchemaFor500ResponseBodyApplicationVndArduinoDevicev2Passjson = Error
...
_response_for_500 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.devicev2.pass+json': api_client.MediaType(
            schema=SchemaFor500ResponseBodyApplicationVndArduinoDevicev2Passjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    ...
    def _devices_v2_pass_set_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_devicev2_pass.serialize(body, content_type)
...
class DevicesV2PassSet(BaseApi):
    ...
    def devices_v2_pass_set(
        ...
        return self._devices_v2_pass_set_oapg(
            body=body,

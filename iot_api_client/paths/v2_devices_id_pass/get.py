...
# Query params
SuggestedPasswordSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'suggested_password': typing.Union[SuggestedPasswordSchema, bool, ],
    },
    total=False
)
...
request_query_suggested_password = api_client.QueryParameter(
    name="suggested_password",
    style=api_client.ParameterStyle.FORM,
    schema=SuggestedPasswordSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _devices_v2_pass_get_oapg(
        ...
        for parameter in (
            request_query_suggested_password,
        ):
...
class DevicesV2PassGet(BaseApi):
    ...
    def devices_v2_pass_get(
        ...
        return self._devices_v2_pass_get_oapg(

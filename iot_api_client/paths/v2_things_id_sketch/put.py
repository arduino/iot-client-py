...
# body param
SchemaForRequestBodyApplicationJson = ThingSketch
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ThingSketch


request_body_thing_sketch = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _things_v2_create_sketch_oapg(
        self,
    ...
    def _things_v2_create_sketch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_thing_sketch.serialize(body, content_type)
...
class ThingsV2CreateSketch(BaseApi):
    ...
    def things_v2_create_sketch(
        ...
        return self._things_v2_create_sketch_oapg(
            body=body,

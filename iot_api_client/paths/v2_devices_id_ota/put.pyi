...
# body param
SchemaForRequestBodyApplicationJson = Devicev2Otabinaryurl
SchemaForRequestBodyApplicationXWwwFormUrlencoded = Devicev2Otabinaryurl


request_body_devicev2_otabinaryurl = api_client.RequestBody(
    content={
...
SchemaFor410ResponseBodyApplicationJson = Error
...
class BaseApi(api_client.Api):
    ...
    def _devices_v2_ota_send_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_devicev2_otabinaryurl.serialize(body, content_type)
...
class DevicesV2OtaSend(BaseApi):
    ...
    def devices_v2_ota_send(
        ...
        return self._devices_v2_ota_send_oapg(
            body=body,

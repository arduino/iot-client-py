...
# body param
SchemaForRequestBodyApplicationJson = ThingClone
SchemaForRequestBodyApplicationXWwwFormUrlencoded = ThingClone


request_body_thing_clone = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _things_v2_clone_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_thing_clone.serialize(body, content_type)
...
class ThingsV2Clone(BaseApi):
    ...
    def things_v2_clone(
        ...
        return self._things_v2_clone_oapg(
            body=body,

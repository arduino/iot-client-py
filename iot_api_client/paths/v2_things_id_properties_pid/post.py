...
SchemaFor200ResponseBodyApplicationVndArduinoPropertyjson = ArduinoProperty
SchemaFor200ResponseBodyApplicationVndGoaErrorjson = ArduinoProperty
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.property+json': api_client.MediaType(
            schema=SchemaFor200ResponseBodyApplicationVndArduinoPropertyjson),
...
SchemaFor404ResponseBodyApplicationVndArduinoPropertyjson = Error
...
_response_for_404 = api_client.OpenApiResponse(
    ...
    content={
        'application/vnd.arduino.property+json': api_client.MediaType(
            schema=SchemaFor404ResponseBodyApplicationVndArduinoPropertyjson),
        'application/vnd.goa.error+json': api_client.MediaType(
...
class BaseApi(api_client.Api):
    @typing.overload
    def _properties_v2_update_oapg(
        self,
...
class PropertiesV2Update(BaseApi):

...
class BodyExpression(BaseModel):
    """
    BodyExpression
    """ # noqa: E501
    expression: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Content of the body of a message, variables are allowed")

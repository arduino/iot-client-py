...
class ArduinoSeriesRawBatchLastvalue(BaseModel):
    ...
    """ # noqa: E501
    responses: List[ArduinoSeriesRawLastValueResponse] = Field(description="Responses of the request")
    status: StrictStr = Field(description="Status of the response")
    __properties: ClassVar[List[str]] = ["responses", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "responses": [ArduinoSeriesRawLastValueResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None,

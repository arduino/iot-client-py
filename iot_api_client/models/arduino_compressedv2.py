...
class ArduinoCompressedv2(BaseModel):
    ...
    """
    authority_key_identifier: Optional[StrictStr] = Field(None, description="The Authority Key Identifier of the certificate")
    ...
    __properties = ["authority_key_identifier", "not_after", "not_before", "serial", "signature", "signature_asn1_x", "signature_asn1_y"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArduinoCompressedv2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArduinoCompressedv2:
        """Create an instance of ArduinoCompressedv2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArduinoCompressedv2.parse_obj(obj)

        _obj = ArduinoCompressedv2.parse_obj({

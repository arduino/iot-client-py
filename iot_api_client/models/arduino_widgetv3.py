...
class ArduinoWidgetv3(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["has_permission_incompatibility", "has_type_incompatibility", "has_unlinked_variable", "height", "height_mobile", "id", "name", "options", "page_id", "type", "variables", "width", "width_mobile", "x", "x_mobile", "y", "y_mobile"]

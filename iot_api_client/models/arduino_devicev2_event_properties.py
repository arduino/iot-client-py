...
class ArduinoDevicev2EventProperties(BaseModel):
    ...
    """ # noqa: E501
    events: List[ArduinoDevicev2SimpleProperties] = Field(description="ArduinoDevicev2SimplePropertiesCollection is the media type for an array of ArduinoDevicev2SimpleProperties (default view)")

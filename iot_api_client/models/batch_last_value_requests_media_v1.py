...
class BatchLastValueRequestsMediaV1(BaseModel):
    ...
    """ # noqa: E501
    requests: List[BatchQueryRawLastValueRequestMediaV1] = Field(description="Requests")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [BatchQueryRawLastValueRequestMediaV1.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj

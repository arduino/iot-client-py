...
class ArduinoSeriesRawBatch(BaseModel):
    """
    ArduinoSeriesRawBatch media type (default view)
    """
    resp_version: StrictInt = Field(..., description="Response version")
    responses: conlist(ArduinoSeriesRawResponse) = Field(..., description="Responses of the request")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArduinoSeriesRawBatch:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArduinoSeriesRawBatch:
        """Create an instance of ArduinoSeriesRawBatch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArduinoSeriesRawBatch.parse_obj(obj)

        _obj = ArduinoSeriesRawBatch.parse_obj({
            "resp_version": obj.get("resp_version"),
            "responses": [ArduinoSeriesRawResponse.from_dict(_item) for _item in obj.get("responses")] if obj.get("responses") is not None else None
        })
        return _obj

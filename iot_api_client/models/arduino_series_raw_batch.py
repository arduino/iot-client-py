...
class ArduinoSeriesRawBatch(BaseModel):
    ...
    responses: List[ArduinoSeriesRawResponse] = Field(description="Responses of the request")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responses": [ArduinoSeriesRawResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj

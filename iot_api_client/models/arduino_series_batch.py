...
class ArduinoSeriesBatch(BaseModel):
    ...
    responses: List[ArduinoSeriesResponse] = Field(description="Responses of the request")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responses": [ArduinoSeriesResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj

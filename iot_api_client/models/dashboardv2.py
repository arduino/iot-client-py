...
class Dashboardv2(BaseModel):
    ...
    name: Optional[constr(strict=True, max_length=64)] = Field(None, description="The friendly name of the dashboard")
    widgets: Optional[conlist(Widget)] = Field(None, description="Widgets attached to this dashboard")
    __properties = ["cover_image", "name", "widgets"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Dashboardv2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Dashboardv2:
        """Create an instance of Dashboardv2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Dashboardv2.parse_obj(obj)

        _obj = Dashboardv2.parse_obj({

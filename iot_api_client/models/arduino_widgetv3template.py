...
class ArduinoWidgetv3template(BaseModel):
    """
    ...
    page_id: StrictStr = Field(description="The ID of the page the widget belongs to, \"0\" if it's in the main page")
    type: StrictStr = Field(description="The type of the widget")
    variables: Optional[List[ArduinoTemplatevariable]] = Field(default=None, description="ArduinoTemplatevariableCollection is the media type for an array of ArduinoTemplatevariable (default view)")
    ...
    __properties: ClassVar[List[str]] = ["height", "height_mobile", "name", "options", "page_id", "type", "variables", "width", "width_mobile", "x", "x_mobile", "y", "y_mobile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "variables": [ArduinoTemplatevariable.from_dict(_item) for _item in obj["variables"]] if obj.get("variables") is not None else None,
            "width": obj.get("width"),

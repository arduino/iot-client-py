...
class ThingCreate(BaseModel):
    ...
    tags: Optional[List[Tag]] = Field(default=None, description="Optional set of tags")
    timezone: Optional[StrictStr] = Field(default='America/New_York', description="A time zone name Check /v2/timezones for a list of valid names.")
    ...
    __properties: ClassVar[List[str]] = ["assistant", "device_id", "id", "name", "properties", "tags", "timezone", "webhook_active", "webhook_uri"]

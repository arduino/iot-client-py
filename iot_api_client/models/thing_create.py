...
class ThingCreate(BaseModel):
    ...
    tags: Optional[conlist(Tag)] = Field(None, description="Optional set of tags")
    timezone: Optional[StrictStr] = Field('America/New_York', description="A time zone name Check /v2/timezones for a list of valid names.")
    ...
    __properties = ["assistant", "device_id", "id", "name", "properties", "tags", "timezone", "webhook_active", "webhook_uri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ThingCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ThingCreate:
        """Create an instance of ThingCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ThingCreate.parse_obj(obj)

        _obj = ThingCreate.parse_obj({
            ...
            "timezone": obj.get("timezone") if obj.get("timezone") is not None else 'America/New_York',

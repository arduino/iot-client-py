...
class ArduinoAction(BaseModel):
    ...
    """ # noqa: E501
    created_by: Optional[StrictStr] = Field(default=None, description="Id of the user who created the action")
    description: Optional[StrictStr] = Field(default=None, description="The description of the action")
    email: Optional[EmailAction] = None
    id: Optional[StrictStr] = Field(default=None, description="The id of the action")
    kind: Optional[StrictStr] = Field(default=None, description="The kind of the action")
    name: Optional[StrictStr] = Field(default=None, description="The name of the action")
    ...
    __properties: ClassVar[List[str]] = ["created_by", "description", "email", "id", "kind", "name", "organization_id", "push_notification", "trigger_id"]

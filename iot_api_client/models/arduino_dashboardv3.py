...
class ArduinoDashboardv3(BaseModel):
    """
    ...
    widgets: Optional[List[ArduinoWidgetv3]] = Field(default=None, description="ArduinoWidgetv3Collection is the media type for an array of ArduinoWidgetv3 (default view)")
    __properties: ClassVar[List[str]] = ["cover_image", "created_by", "id", "name", "organization_id", "pages", "shared_by", "shared_with", "updated_at", "widgets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "widgets": [ArduinoWidgetv3.from_dict(_item) for _item in obj["widgets"]] if obj.get("widgets") is not None else None
        })
        return _obj

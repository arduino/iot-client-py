...
class PushAction(BaseModel):
    ...
    """ # noqa: E501
    body: BodyExpression
    delivery: PushDeliveryOpts
    title: TitleExpression
    __properties: ClassVar[List[str]] = ["body", "delivery", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "delivery": PushDeliveryOpts.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None,
            "title": TitleExpression.from_dict(obj["title"]) if obj.get("title") is not None else None
        })
        return _obj

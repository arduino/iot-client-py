...
class ModelProperty(BaseModel):
    ...
    persist: Optional[StrictBool] = Field(True, description="If true, data will persist into a timeseries database")
    ...
    variable_name: Optional[constr(strict=True, max_length=64)] = Field(None, description="The  sketch variable name of the property")
    __properties = ["max_value", "min_value", "name", "permission", "persist", "tag", "type", "update_parameter", "update_strategy", "variable_name"]
    ...
    def update_strategy_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ON_CHANGE', 'TIMED'):

...
class ArduinoSeriesResponse(BaseModel):
    ...
    values: conlist(Union[StrictFloat, StrictInt]) = Field(..., description="Values in Float")
    __properties = ["aggregation", "count_values", "from_date", "interval", "message", "property_id", "property_name", "property_type", "query", "resp_version", "series_limit", "status", "thing_id", "times", "to_date", "values"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArduinoSeriesResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArduinoSeriesResponse:
        """Create an instance of ArduinoSeriesResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArduinoSeriesResponse.parse_obj(obj)

        _obj = ArduinoSeriesResponse.parse_obj({

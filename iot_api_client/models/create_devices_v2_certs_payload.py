...
class CreateDevicesV2CertsPayload(BaseModel):
    """
    CreateDevicesV2CertsPayload
    """
    ca: Optional[StrictStr] = Field(None, description="The Certification Authority you want to use")
    csr: constr(strict=True, max_length=1024) = Field(..., description="The certificate request in pem format")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDevicesV2CertsPayload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDevicesV2CertsPayload:
        """Create an instance of CreateDevicesV2CertsPayload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDevicesV2CertsPayload.parse_obj(obj)

        _obj = CreateDevicesV2CertsPayload.parse_obj({
            "ca": obj.get("ca"),
            "csr": obj.get("csr"),

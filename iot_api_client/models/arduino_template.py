...
class ArduinoTemplate(BaseModel):
    ...
    """ # noqa: E501
    dashboards: Optional[List[StrictStr]] = None
    things: List[ArduinoThingresult] = Field(description="ArduinoThingresultCollection is the media type for an array of ArduinoThingresult (default view)")
    triggers: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["dashboards", "things", "triggers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "things": [ArduinoThingresult.from_dict(_item) for _item in obj["things"]] if obj.get("things") is not None else None,

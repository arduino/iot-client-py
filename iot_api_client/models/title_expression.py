...
class TitleExpression(BaseModel):
    """
    TitleExpression
    """ # noqa: E501
    expression: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Content of the title (or subject) of a message, variables are allowed")
    variables: Optional[List[Variable]] = Field(default=None, description="Variables used by the expression")

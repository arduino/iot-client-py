...
class Devicev2(BaseModel):
    ...
    type: Optional[StrictStr] = Field(None, description="The type of the device")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Devicev2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Devicev2:
        """Create an instance of Devicev2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Devicev2.parse_obj(obj)

        _obj = Devicev2.parse_obj({

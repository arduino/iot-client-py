...
class ArduinoSeriesRawResponse(BaseModel):
    ...
    series_limit: Optional[StrictInt] = Field(default=None, description="Max of values")
    ...
    __properties: ClassVar[List[str]] = ["count_values", "from_date", "message", "property_id", "property_name", "property_type", "query", "resp_version", "series", "series_limit", "sort", "status", "thing_id", "times", "to_date", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "series": BatchQueryRawResponseSeriesMediaV1.from_dict(obj["series"]) if obj.get("series") is not None else None,

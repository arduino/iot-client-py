...
class CreateLoraDevicesV1Payload(BaseModel):
    ...
    app_eui: Optional[constr(strict=True)] = Field(None, description="The app eui of the lora device")
    app_key: Optional[constr(strict=True)] = Field(None, description="The app key of the lora device")
    eui: constr(strict=True) = Field(..., description="The eui of the lora device")
    ...
    serial: Optional[StrictStr] = Field(None, description="The optional serial number")
    ...
    __properties = ["app", "app_eui", "app_key", "eui", "frequency_plan", "name", "serial", "type", "user_id"]
    ...
    @validator('frequency_plan')
    def frequency_plan_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('EU_863_870_TTN', 'US_902_928_FSB_2', 'EU_433', 'AU_915_928_FSB_2', 'CN_470_510_FSB_11', 'AS_920_923', 'AS_920_923_TTN_AU', 'AS_923_925', 'AS_923_925_TTN_AU', 'KR_920_923_TTN', 'IN_865_867'):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('lora-device', 'mkrwan1300', 'mkrwan1310'):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateLoraDevicesV1Payload:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateLoraDevicesV1Payload:
        """Create an instance of CreateLoraDevicesV1Payload from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateLoraDevicesV1Payload.parse_obj(obj)

        _obj = CreateLoraDevicesV1Payload.parse_obj({
            "app": obj.get("app"),

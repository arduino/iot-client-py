...
class ArduinoDevicev2propertyvalueValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["payload", "seqno", "statistics"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seqno": obj.get("seqno"),
            "statistics": ArduinoDevicev2propertyvalueValueStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None
        })
        return _obj

...
class Devicev2Otaurlpyalod(BaseModel):
    ...
    """ # noqa: E501
    binary_key: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The object key of the binary")
    sha256: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The sha256 of the binary")
    user_id: Optional[StrictStr] = Field(default=None, description="The id of the user who is requesting the url")
    __properties: ClassVar[List[str]] = ["binary_key", "sha256", "user_id"]

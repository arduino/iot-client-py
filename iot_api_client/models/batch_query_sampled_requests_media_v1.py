...
class BatchQuerySampledRequestsMediaV1(BaseModel):
    ...
    """
    requests: conlist(BatchQuerySampledRequestMediaV1) = Field(..., description="Requests")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchQuerySampledRequestsMediaV1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchQuerySampledRequestsMediaV1:
        """Create an instance of BatchQuerySampledRequestsMediaV1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchQuerySampledRequestsMediaV1.parse_obj(obj)

        _obj = BatchQuerySampledRequestsMediaV1.parse_obj({
            "requests": [BatchQuerySampledRequestMediaV1.from_dict(_item) for _item in obj.get("requests")] if obj.get("requests") is not None else None,

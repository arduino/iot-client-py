...
class Dashboardv3(BaseModel):
    ...
    pages: Optional[Annotated[List[Pagepayload], Field(max_length=30)]] = Field(default=None, description="List of sub-pages")
    soft_deleted: Optional[StrictBool] = Field(default=False, description="If false, restore the thing from the soft deletion")
    widgets: Optional[List[Widgetv3]] = Field(default=None, description="Widgets attached to this dashboard")
    __properties: ClassVar[List[str]] = ["cover_image", "name", "pages", "soft_deleted", "widgets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "pages": [Pagepayload.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "soft_deleted": obj.get("soft_deleted") if obj.get("soft_deleted") is not None else False,
            "widgets": [Widgetv3.from_dict(_item) for _item in obj["widgets"]] if obj.get("widgets") is not None else None
        })
        return _obj

...
class PropertiesValues(BaseModel):
    ...
    PropertiesValues
    """ # noqa: E501
    input: Optional[StrictBool] = Field(default=False, description="If true, send property values to device's input topic.")
    properties: List[PropertiesValue]
    __properties: ClassVar[List[str]] = ["input", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [PropertiesValue.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj

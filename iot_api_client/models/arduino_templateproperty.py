...
class ArduinoTemplateproperty(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The friendly id of the property")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "permission", "type", "update_parameter", "update_strategy", "variable_name"]

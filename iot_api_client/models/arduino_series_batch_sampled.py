...
class ArduinoSeriesBatchSampled(BaseModel):
    ...
    responses: List[ArduinoSeriesSampledResponse] = Field(description="Responses of the request")
    __properties: ClassVar[List[str]] = ["resp_version", "responses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responses": [ArduinoSeriesSampledResponse.from_dict(_item) for _item in obj["responses"]] if obj.get("responses") is not None else None
        })
        return _obj

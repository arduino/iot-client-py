...
class ArduinoWidgetv2(BaseModel):
    ...
    """
    has_permission_incompatibility: Optional[StrictBool] = Field(None, description="True if the linked variables permissions are incompatible with the widget")
    has_type_incompatibility: Optional[StrictBool] = Field(None, description="True if the linked variables types are incompatible with the widget")
    has_unlinked_variable: Optional[StrictBool] = Field(None, description="If it's true the widget is linked to a soft-deleted variable")
    ...
    variables: Optional[conlist(ArduinoLinkedvariable)] = Field(None, description="ArduinoLinkedvariableCollection is the media type for an array of ArduinoLinkedvariable (default view)")
    ...
    __properties = ["has_permission_incompatibility", "has_type_incompatibility", "has_unlinked_variable", "height", "height_mobile", "id", "name", "options", "type", "variables", "width", "width_mobile", "x", "x_mobile", "y", "y_mobile"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArduinoWidgetv2:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArduinoWidgetv2:
        """Create an instance of ArduinoWidgetv2 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArduinoWidgetv2.parse_obj(obj)

        _obj = ArduinoWidgetv2.parse_obj({
            ...
            "type": obj.get("type"),
            "variables": [ArduinoLinkedvariable.from_dict(_item) for _item in obj.get("variables")] if obj.get("variables") is not None else None,
            "width": obj.get("width"),

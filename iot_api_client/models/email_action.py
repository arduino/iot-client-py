...
class EmailAction(BaseModel):
    ...
    """ # noqa: E501
    body: BodyExpression
    delivery: EmailDeliveryOpts
    subject: TitleExpression
    __properties: ClassVar[List[str]] = ["body", "delivery", "subject"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": BodyExpression.from_dict(obj["body"]) if obj.get("body") is not None else None,
            "delivery": EmailDeliveryOpts.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None,
            "subject": TitleExpression.from_dict(obj["subject"]) if obj.get("subject") is not None else None
        })
        return _obj

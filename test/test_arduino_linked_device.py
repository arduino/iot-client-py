...
class TestArduinoLinkedDevice(unittest.TestCase):
    """ArduinoLinkedDevice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArduinoLinkedDevice:
        """Test ArduinoLinkedDevice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArduinoLinkedDevice`
        """
        model = ArduinoLinkedDevice()
        if include_optional:
            return ArduinoLinkedDevice(
    ...
    def testArduinoLinkedDevice(self):
        """Test ArduinoLinkedDevice"""

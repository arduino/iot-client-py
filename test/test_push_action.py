...
class TestPushAction(unittest.TestCase):
    """PushAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PushAction:
        """Test PushAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PushAction`
        """
        model = PushAction()
        if include_optional:
            return PushAction(

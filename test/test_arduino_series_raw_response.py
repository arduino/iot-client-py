...
class TestArduinoSeriesRawResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ArduinoSeriesRawResponse:
        """Test ArduinoSeriesRawResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArduinoSeriesRawResponse`
        """
        model = ArduinoSeriesRawResponse()
        if include_optional:

...
class TestCreateClaimedDevicesV2Payload(unittest.TestCase):
    """CreateClaimedDevicesV2Payload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateClaimedDevicesV2Payload:
        """Test CreateClaimedDevicesV2Payload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateClaimedDevicesV2Payload`
        """
        model = CreateClaimedDevicesV2Payload()
        if include_optional:
            return CreateClaimedDevicesV2Payload(
                id = '',
                ble_mac = '62:CB:20:42:30:c0012345678910111213141516',
                connection_type = 'wifi',
                fqbn = '',
                name = '0',
                serial = '0',
                type = 'mkrwifi1010',
                unique_hardware_id = '0123456789101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960616263',
                user_id = '',
    ...
    def testCreateClaimedDevicesV2Payload(self):
        """Test CreateClaimedDevicesV2Payload"""

...
class TestArduinoAction(unittest.TestCase):
    """ArduinoAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArduinoAction:
        """Test ArduinoAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArduinoAction`
        """
        model = ArduinoAction()
        if include_optional:

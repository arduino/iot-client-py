...
class TestArduinoActionTemplate(unittest.TestCase):
    """ArduinoActionTemplate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArduinoActionTemplate:
        """Test ArduinoActionTemplate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArduinoActionTemplate`
        """
        model = ArduinoActionTemplate()
        if include_optional:
            return ArduinoActionTemplate(
                description = '',
    ...
    def testArduinoActionTemplate(self):
        """Test ArduinoActionTemplate"""

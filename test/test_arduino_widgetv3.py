...
class TestArduinoWidgetv3(unittest.TestCase):
    """ArduinoWidgetv3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArduinoWidgetv3:
        """Test ArduinoWidgetv3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArduinoWidgetv3`
        """
        model = ArduinoWidgetv3()
        if include_optional:
            return ArduinoWidgetv3(

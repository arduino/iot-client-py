...
class TestArduinoWidgetv3template(unittest.TestCase):
    """ArduinoWidgetv3template unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArduinoWidgetv3template:
        """Test ArduinoWidgetv3template
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArduinoWidgetv3template`
        """
        model = ArduinoWidgetv3template()
        if include_optional:
            return ArduinoWidgetv3template(
                height = 56,
                height_mobile = 56,
                name = '',
                options = { },
    ...
    def testArduinoWidgetv3template(self):
        """Test ArduinoWidgetv3template"""
